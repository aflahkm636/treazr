        ...
        <div className="max-w-5xl mx-auto px-4 py-10 mt-10">
            ...
            {orders.length === 0 ? (
                ...
                <div className="space-y-6">
                    {orders.map((order) => (
                        <div key={order.id} className="border border-gray-200 rounded-xl p-6 shadow-sm hover:shadow-md transition">
                            <div 
                            ...
                            >
                                <div className="flex justify-between border-b pb-4 mb-4">
                                    ...
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <span className="text-gray-800 font-medium">${Number(order.total || 0).toFixed(2)}</span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="mt-4 border-t pt-4">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-6 mb-6">
                                        {(order.shippingAddress || order.address) && (
                                            <div>
                                                ...
                                                <div className="text-gray-600">
                                                    ...
                                                    <p>{(order.shippingAddress || order.address).city}, {(order.shippingAddress || order.address).state} {(order.shippingAddress || order.address).zip || (order.shippingAddress || order.address).zipCode}</p>
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-600">{order.paymentMethod?.toUpperCase() || "Not specified"}</p>
                                        </div>
                                    </div>
